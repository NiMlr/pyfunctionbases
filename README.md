...
<a href="https://www.codecogs.com/eqnedit.php?latex=f_{n&plus;1}(x)&space;=&space;f_n(x)*x" target="_blank"><img src="https://latex.codecogs.com/gif.latex?f_{n&plus;1}(x)&space;=&space;f_n(x)*x" class="center" title="f_{n+1}(x) = f_n(x)*x"/></a>
